...
const getClient = () => {
  // Check multiple sources for the key to ensure it works in Vercel/Browser
  const apiKey = 
    (typeof process !== 'undefined' ? process.env.OPENAI_API_KEY : undefined) || 
    (typeof process !== 'undefined' ? process.env.REACT_APP_OPENAI_API_KEY : undefined) ||
...
export const sendMessageToOpenAI = async (
  ...
  try {
    ...
    // Handle Quota/Billing Errors specific to OpenAI
    ...
    // Fallback for other key related errors
